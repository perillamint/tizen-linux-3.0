...
REGULATOR_INIT(ldo12, "VUOTG_3.0V", 3000000, 3000000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
REGULATOR_INIT(ldo13, "NFC_AVDD_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
...
static struct regulator_init_data ldo25_init_data = {
	.constraints = {
		.name = "LED_A_2.8V",
		.min_uV = 2800000,
		.max_uV = 2800000,
...
struct max77686_opmode_data redwood_max77686_opmode_data[MAX77686_REG_MAX] = {
...
struct max77686_platform_data redwood_max77686_info = {
	...
	.opmode_data = redwood_max77686_opmode_data,
...
struct max77693_regulator_data redwood_max77693_regulators[] = {
