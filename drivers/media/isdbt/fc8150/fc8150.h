...
#define IOCTL_ISDBT_BYTE_READ			_IOWR(IOCTL_MAGIC, 4,\
	ioctl_info)
#define IOCTL_ISDBT_WORD_READ			_IOWR(IOCTL_MAGIC, 5,\
	ioctl_info)
#define IOCTL_ISDBT_LONG_READ			_IOWR(IOCTL_MAGIC, 6,\
	ioctl_info)
#define IOCTL_ISDBT_BULK_READ			_IOWR(IOCTL_MAGIC, 7,\
	ioctl_info)
#define IOCTL_ISDBT_BYTE_WRITE			_IOW(IOCTL_MAGIC, 8,\
	ioctl_info)
