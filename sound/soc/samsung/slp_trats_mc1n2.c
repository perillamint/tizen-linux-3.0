...
static struct slp_jack_button_zone slp_jack_button_zones[] = {
	{
...
struct slp_jack_platform_data trats_jack_pdata = {
	...
	.button_zones = slp_jack_button_zones,
	.num_button_zones = ARRAY_SIZE(slp_jack_button_zones),
	.det_gpio = GPIO_DET_35,
	.button_gpio = GPIO_EAR_SEND_END,
...
{
	/* do nothing
	 * this exist only for compatibility of OAL
	 */
	return 0;
}
