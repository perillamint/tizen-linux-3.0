...
#include <linux/idr.h>
/* BEGIN TIZEN_Bluetooth :: BCM driver porting */
...
/* BEGIN TIZEN_Bluetooth :: BCM driver porting */
int bcm4334_hci_register_notifier(struct notifier_block *nb)
{
	return atomic_notifier_chain_register(&hci_notifier, nb);
}

int bcm4334_hci_unregister_notifier(struct notifier_block *nb)
{
...
/* BEGIN TIZEN_Bluetooth :: BCM driver porting */
	/* Notify the registered modules on adapter REG and UNREG */
...
/* BEGIN TIZEN_Bluetooth :: NULL pointer dereference PLM P130603-1933 */
		struct hci_command_hdr *sent;
		u16 opcode;
		struct sk_buff *skb;

		if (!hdev->sent_cmd || !hdev->sent_cmd->data)
			return;
		...
		struct sk_buff *skb;
#endif
/* END TIZEN_Bluetooth :: NULL pointer dereference PLM P130603-1933 */
