...
enum set_Factory_DefectPixel_Cmd {
	...
	FACTORY_DEFECTPIXEL_CID_1 = 4,
	FACTORY_DEFECTPIXEL_CID_2 = 5,
	FACTORY_DEFECTPIXEL_CID_3 = 6,
	FACTORY_DEFECTPIXEL_WRITE_BLACK = 7,
	FACTORY_DEFECTPIXEL_WRITE_WHITE = 8,
	FACTORY_DEFECTPIXEL_CID_WRITE = 9,
};
...
enum v4l2_widget_mode_level {
	V4L2_WIDGET_MODE_LEVEL_0 = 0,
	V4L2_WIDGET_MODE_LEVEL_1,
	V4L2_WIDGET_MODE_LEVEL_2,
};
